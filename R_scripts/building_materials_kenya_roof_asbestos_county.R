...
barplot <- table_1_select_county %>%
  ...
  geom_text(aes(x = 20 , y = 1.4, label = "Average Asbestos Roofs (Kenya)"), 
            size = 3, 
            angle=90, vjust = 1.5) +
  geom_hline(yintercept = 0.9, linetype = "dashed", color = "black") +
  geom_text(aes(x = 20 , y = 0.9, label = "Average Asbestos Roofs (Rural)"), 
            size = 3,
            angle=90, vjust = 1.5) +
  geom_hline(yintercept = 2.2, linetype = "dashed", color = "black") +
  geom_text(aes(x = 20 , y = 2.2, label = "Average Asbestos Roofs (Urban)"), 
            size = 3,
            angle=90, vjust = 1.5)
...
# Save the plot
ggsave("images/building_materials_kenya_asbestos_county/all_counties_asbestos_barplot.png", width = 7.5, height = 10)
...
# Save the plot
ggsave("images/building_materials_kenya_asbestos_county/all_counties_asbestos_map.png", width = 7.5, height = 10)

barplot + map

ggsave("images/building_materials_kenya_asbestos_county/all_counties_asbestos_barplot_map.png", width = 10, height = 10)
...
fcdc_asbestos_plot <- fcdc_asbestos %>%
  ...
  theme(axis.title.x =element_text(size = 15),
        ...
        plot.caption = element_text(family = "URW Palladio L, Italic",size = 12)) + 
  geom_hline(yintercept = 1.4, color = "black") +
  geom_text(aes(x = 5 , y = 1.4, label = "Average Asbestos Roofs (Kenya)"), 
            size = 3, 
            angle=90, vjust = 1.5) +
  geom_hline(yintercept = 0.9, linetype = "dashed", color = "black") +
  geom_text(aes(x = 5 , y = 0.9, label = "Average Asbestos Roofs (Rural)"), 
            size = 3,
            angle=90, vjust = 1.5) +
  geom_hline(yintercept = 2.2, linetype = "dashed", color = "black") +
  geom_text(aes(x = 5 , y = 2.2, label = "Average Asbestos Roofs (Urban)"), 
            size = 3,
            angle=90, vjust = 1.5)
...
lreb_asbestos_plot <- lreb_asbestos %>%
  ...
  theme(axis.title.x =element_text(size = 15),
        ...
        plot.caption = element_text(family = "URW Palladio L, Italic",size = 12)) +
  geom_hline(yintercept = 1.4, color = "black") +
  geom_text(aes(x = 7.5 , y = 1.4, label = "Average Asbestos Roofs (Kenya)"), 
            size = 3, 
            angle=90, vjust = 1.5) +
  geom_hline(yintercept = 0.9, linetype = "dashed", color = "black") +
  geom_text(aes(x = 7.5 , y = 0.9, label = "Average Asbestos Roofs (Rural)"), 
            size = 3,
            angle=90, vjust = 1.5) +
  geom_hline(yintercept = 2.2, linetype = "dashed", color = "black") +
  geom_text(aes(x = 7.5 , y = 2.2, label = "Average Asbestos Roofs (Urban)"), 
            size = 3,
            angle=90, vjust = 1.5)
...
pwani_asbestos_plot <- pwani_asbestos %>%
  ...
  geom_hline(yintercept = 1.4, color = "black") +
  geom_text(aes(x = 3 , y = 1.4, label = "Average Asbestos Roofs (Kenya)"), 
            size = 3, 
            angle=90, vjust = 1.5) +
  geom_hline(yintercept = 0.9, linetype = "dashed", color = "black") +
  geom_text(aes(x = 3 , y = 0.9, label = "Average Asbestos Roofs (Rural)"), 
            size = 3,
            angle=90, vjust = 1.5) +
  geom_hline(yintercept = 2.2, linetype = "dashed", color = "black") +
  geom_text(aes(x = 3 , y = 2.2, label = "Average Asbestos Roofs (Urban)"), 
            size = 3,
            angle=90, vjust = 1.5)
...
sekeb_asbestos_plot <- sekeb_asbestos %>%
  ...
  theme(axis.title.x =element_text(size = 15),
        ...
        plot.caption = element_text(family = "URW Palladio L, Italic",size = 12)) +  
  geom_hline(yintercept = 1.4, color = "black") +
  geom_text(aes(x = 2 , y = 1.4, label = "Average Asbestos Roofs (Kenya)"), 
            size = 3, 
            angle=90, vjust = 1.5) +
  geom_hline(yintercept = 0.9, linetype = "dashed", color = "black") +
  geom_text(aes(x = 2 , y = 0.9, label = "Average Asbestos Roofs (Rural)"), 
            size = 3,
            angle=90, vjust = 1.5) +
  geom_hline(yintercept = 2.2, linetype = "dashed", color = "black") +
  geom_text(aes(x = 2 , y = 2.2, label = "Average Asbestos Roofs (Urban)"), 
            size = 3,
            angle=90, vjust = 1.5)
...
nakeb_asbestos_plot <- nakeb_asbestos %>%
  ...
  theme(axis.title.x =element_text(size = 15),
        ...
        plot.caption = element_text(family = "URW Palladio L, Italic",size = 12)) +
  geom_hline(yintercept = 1.4, color = "black") +
  geom_text(aes(x = 1.5 , y = 1.4, label = "Average Asbestos Roofs (Kenya)"), 
            size = 3, 
            angle=90, vjust = 1.5) +
  geom_hline(yintercept = 0.9, linetype = "dashed", color = "black") +
  geom_text(aes(x = 1.5 , y = 0.9, label = "Average Asbestos Roofs (Rural)"), 
            size = 3,
            angle=90, vjust = 1.5) +
  geom_hline(yintercept = 2.2, linetype = "dashed", color = "black") +
  geom_text(aes(x = 1.5 , y = 2.2, label = "Average Asbestos Roofs (Urban)"), 
            size = 3,
            angle=90, vjust = 1.5)
